...
UPDATE TELEFONOS
SET FECHA_INS = 
(SELECT FECHA_INS FROM CLIENTES WHERE ID_CLIENTE = TELEFONOS.ID_CLIENTE)
FROM CLIENTES WHERE TELEFONOS.ID_CLIENTE = CLIENTES.ID_CLIENTE

UPDATE DIRECCIONES
SET FECHA_INS = 
(SELECT FECHA_INS FROM CLIENTES WHERE ID_CLIENTE = DIRECCIONES.ID_CLIENTE)
FROM CLIENTES WHERE DIRECCIONES.ID_CLIENTE = CLIENTES.ID_CLIENTE

UPDATE CORREOS
SET FECHA_INS = 
(SELECT FECHA_INS FROM CLIENTES WHERE ID_CLIENTE = CORREOS.ID_CLIENTE)
FROM CLIENTES WHERE CORREOS.ID_CLIENTE = CLIENTES.ID_CLIENTE

UPDATE TARJETAS
SET FECHA_INS = 
(SELECT FECHA_INS FROM CLIENTES WHERE ID_CLIENTE = TARJETAS.ID_CLIENTE)
FROM CLIENTES WHERE TARJETAS.ID_CLIENTE = CLIENTES.ID_CLIENTE
